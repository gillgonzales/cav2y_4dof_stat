...
if(plottype!="boxplot"){
  ...
  dirplot<-paste(rdafolder,"plots","kw_boxplot",plottype,"bd",sep="/")
  ...
  data<-bind_rows(dtdeb1,dtdeb2,dtdeb3,dtdeb4)
  ...
  imgfilename=paste(vardata,plottype,"mkw_edbd_a",alpha,rdafolder,".png",sep="_")
  ...
  p<-ggplot()+
    ...
    geom_boxplot(aes(algo,dtdeb3[[vardata]]),dtdeb3,color=cl5,stat = "boxplot")+
    geom_boxplot(aes(algo,dtded3[[vardata]]),dtded3,color=cl6,stat = "boxplot")+
    geom_boxplot(aes(algo,dtdeb4[[vardata]]),dtdeb4,color=cl7,stat = "boxplot")+
