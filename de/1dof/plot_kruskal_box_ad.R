...
if(plottype!="boxplot"){
  ...
  imgfilename=paste(vardata,plottype,"mkw_edth_a",alpha,rdafolder,"_punadj.png",sep="_")
  ...
  #0.05
    cls=c("A"="red","B"="blue","ABC"="orange","C"="purple","BC"="blue","AB"="green")
  }
  ...
  p<-ggplot()+
    ...
    scale_y_continuous(breaks=seq(0.038,0.124,length.out=6))+
    expand_limits(y=c(0.038,0.124))+
