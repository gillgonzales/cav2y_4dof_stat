...
de1iters=seq(1,length(datade1[[ydata]]),by=1)
de2iters=seq(1,length(datade2[[ydata]]),by=1)
de3iters=seq(1,length(datade3[[ydata]]),by=1)
...
gplot <- ggplot()+
  ...
  geom_point(aes(x=de2iters,y=datade2[[ydata]]),color='red',size=2.5,shape=18,alpha = 1/3)+
